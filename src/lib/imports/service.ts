...
export async function getImportSettings() {
  ...
  return (
    settings ?? {
      ...
      workerEnabled: false,
      maxPreflightJobsPerDay: 100,
      maxJobsPerWorkerRun: 5,
      maxConcurrentJobs: 2,
      perDomainDelayMs: 1500,
      dnsTimeoutMs: 3000,
      connectionTimeoutMs: 5000,
      overallRequestTimeoutMs: 12000,
      maxRedirects: 5,
      maxResponseBytes: 1_000_000,
      preflightRetryLimit: 3,
      retryBackoffSeconds: 60,
      preflightRecheckDays: 30,
      minimumBusinessFitScore: 65,
      requireTargetIndustry: true,
      requireTargetLocation: true,
      fetcherUserAgent: process.env.ORBISY_FETCHER_USER_AGENT || "OrbisyPreflight/1.0 (+https://orbisy.com/preflight)",
      deepAuditEnabled: false,
      deepAuditWorkerEnabled: false,
      maxAuditsPerDay: 10,
      maxAuditJobsPerWorkerRun: 1,
      maxConcurrentAudits: 1,
      maxPagesPerAudit: 3,
      maxInternalLinksChecked: 20,
      auditPerDomainDelayMs: 2000,
      auditDnsTimeoutMs: 3000,
      auditConnectionTimeoutMs: 5000,
      auditPageTimeoutMs: 12000,
      overallAuditTimeoutMs: 30000,
      auditMaxRedirects: 5,
      maxResponseBytesPerPage: 1_000_000,
      maxTotalBytesPerAudit: 2_500_000,
      auditRetryLimit: 3,
      auditRetryBackoffSeconds: 120,
      reauditIntervalDays: 90,
      auditMinimumBusinessFitScore: 65,
      minimumAuditConfidence: "medium" as const,
